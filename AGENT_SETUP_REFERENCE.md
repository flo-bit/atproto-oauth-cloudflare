...
<!-- FILE: src/lib/atproto/auth.svelte.ts -->

### `src/lib/atproto/methods.ts`

<!-- FILE: src/lib/atproto/methods.ts -->

### `src/lib/atproto/index.ts`

<!-- FILE: src/lib/atproto/index.ts -->

### `src/lib/atproto/server/signed-cookie.ts`

<!-- FILE: src/lib/atproto/server/signed-cookie.ts -->

### `src/lib/atproto/server/kv-store.ts`

<!-- FILE: src/lib/atproto/server/kv-store.ts -->

### `src/lib/atproto/server/oauth.ts`

<!-- FILE: src/lib/atproto/server/oauth.ts -->

### `src/lib/atproto/server/oauth.remote.ts`

<!-- FILE: src/lib/atproto/server/oauth.remote.ts -->

### `src/lib/atproto/server/repo.remote.ts`

<!-- FILE: src/lib/atproto/server/repo.remote.ts -->

### `src/lib/atproto/server/session.ts`

<!-- FILE: src/lib/atproto/server/session.ts -->

### `src/lib/atproto/server/profile.ts`

<!-- FILE: src/lib/atproto/server/profile.ts -->

### `src/lib/atproto/scripts/generate-key.ts`

<!-- FILE: src/lib/atproto/scripts/generate-key.ts -->

### `src/lib/atproto/scripts/generate-secret.ts`

<!-- FILE: src/lib/atproto/scripts/generate-secret.ts -->

### `src/lib/atproto/scripts/setup-dev.ts`

<!-- FILE: src/lib/atproto/scripts/setup-dev.ts -->

### `src/routes/(oauth)/oauth/callback/+server.ts`

<!-- FILE: src/routes/(oauth)/oauth/callback/+server.ts -->

### `src/routes/(oauth)/oauth/jwks.json/+server.ts`

<!-- FILE: src/routes/(oauth)/oauth/jwks.json/+server.ts -->

### `src/routes/(oauth)/oauth-client-metadata.json/+server.ts`

<!-- FILE: src/routes/(oauth)/oauth-client-metadata.json/+server.ts -->
